...
import { HiOutlinePhone, HiOutlineMail, HiOutlineLocationMarker, HiX, HiMenuAlt3 } from 'react-icons/hi';
...
export default function Home() {
  ...
  const bday = new Date('2001-10-24');
  ...
  return (
    <SC.Main>
      ...
      <SC.SectionHero id='home'>
        <SC.GroupLeftRight>
          <SC.ContainerLeft>
            ...
            <SC.ContainerSocial>
              <SC.CircleSocial href='https://www.linkedin.com/in/thiagoleaodev/' target='_blank' aria-label='Linkedin'>
                <FaLinkedinIn color='white' size='1.8em' />
              </SC.CircleSocial>
              <SC.CircleSocial href='https://github.com/ThiagoLeaoDev' target='_blank' aria-label='Github'>
                <FaGithub color='white' size='1.8em' />
              </SC.CircleSocial>
              <SC.CircleSocial href='https://dribbble.com/thiagoLeao' target='_blank' aria-label='Dribbble'>
                <FaDribbble color='white' size='1.8em' />
              </SC.CircleSocial>
              <SC.CircleSocial href='https://www.figma.com/@thiagoleao' target='_blank' aria-label='Figma'>
          ...
          <SC.ContainerRight>
            <SC.ContainerImage>
              <SC.MainImage src='/portifolio_grey.png' layout='fill' objectFit='cover' quality={100} alt='Portait of Thiago Leão' priority />
              <SC.Circle />
            </SC.ContainerImage>
          </SC.ContainerRight>
        </SC.GroupLeftRight>
      ...
      <SC.SectionAbout id='about'>
        <SC.Content>
          ...
          <SC.ContainerDescAbout>
            <SC.TextDescAbout>
              I'm <SC.GreenText>Thiago Leão</SC.GreenText>, I'm <SC.GreenText>{age}</SC.GreenText> years old and I live in <SC.GreenText>São Vicente-SP</SC.GreenText>.
              <SC.GreenText> Front-end developer</SC.GreenText> and <SC.GreenText>UI Designer</SC.GreenText>, I'm passionate about interfaces, from their creation to development. I like to learn more
              and more about the area, challenges that take me out of my comfort zone are the best.
            </SC.TextDescAbout>
            <SC.Jump />
            <SC.TextDescAbout>
              I have prototyped and developed <SC.GreenText>Landing Pages</SC.GreenText>, <SC.GreenText>Sites</SC.GreenText>, <SC.GreenText>E-commerces</SC.GreenText>,{' '}
              <SC.GreenText>E-mails Marketing</SC.GreenText>, <SC.GreenText>Apps</SC.GreenText> and <SC.GreenText>Programs</SC.GreenText>.
            </SC.TextDescAbout>
          </SC.ContainerDescAbout>
        </SC.Content>
        <SC.TireServices>
          <SC.ContainerComponentAbout left='-20px' top='-150px'>
            <SC.SquareComponent src='/square_dots.svg' width={186} height={186} quality={100} alt='Square' />
          </SC.ContainerComponentAbout>
          <SC.Content>
        ...
        <SC.ContainerEducationJobs>
          <SC.ContainerColumnsEducationJobs>
            ...
            <SC.ColumnEducationJobs>
              ...
              <SC.BoxInfoEducationJobs>
                <SC.DateEducationJobs>August 2023 - Present</SC.DateEducationJobs>
                <SC.TitleEducationJobs>Mid-Level Integration Analyst</SC.TitleEducationJobs>
                <SC.InstitutionEducationJobs>Criando Valor - Tecnologia & Inovação</SC.InstitutionEducationJobs>
              </SC.BoxInfoEducationJobs>

              <SC.BoxInfoEducationJobs>
                <SC.DateEducationJobs>August 2022 - June 2023</SC.DateEducationJobs>
                <SC.TitleEducationJobs>Information Systems Programmer</SC.TitleEducationJobs>
                <SC.InstitutionEducationJobs>JustForYou</SC.InstitutionEducationJobs>
              </SC.BoxInfoEducationJobs>

              <SC.BoxInfoEducationJobs>
                <SC.DateEducationJobs>Octuber 2021 - January 2022</SC.DateEducationJobs>
                <SC.TitleEducationJobs>IT Assistant</SC.TitleEducationJobs>
                <SC.InstitutionEducationJobs>Criando Valor - Tecnologia & Inovação</SC.InstitutionEducationJobs>
              </SC.BoxInfoEducationJobs>
        ...
        <SC.Content>
          ...
          <SC.ContainerProjects>
            {projects.map((project, index) => {
              return <CardProjects key={index} id={project.id} image={project.thumbnailUrl} Title={project.name} Type='ui' />;
            })}
          </SC.ContainerProjects>
        </SC.Content>
      ...
      <SC.Footer>
        <SC.TextFooter>© {year} Thiago Leão. All rights reserved.</SC.TextFooter>
      </SC.Footer>
    </SC.Main>
  );
}
